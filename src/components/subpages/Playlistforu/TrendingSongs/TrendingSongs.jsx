  ...
  return (
    <div>
      <div className="pl-4 sm:px-8 md:px-8 lg:px-8 overflow-y-auto scroll-smooth w-full">
        {/* HEADER */}
        <div className="mb-10">
          <h1 className="text-3xl sm:text-5xl md:text-5xl lg:text-5xl font-extrabold  bg-gradient-to-r from-green-400 via-emerald-500 to-teal-400 bg-clip-text text-transparent">
            Trending Songs
          </h1>
            ...
            >
              ...
              <div className="w-full h-40 rounded-xl overflow-hidden mb-3">
                ...
                <FaHeart
                  ...
                  size={17}
                  onClick={(e) => {
                    (e.stopPropagation(), addtofav(trendingmusic._id));
                  }}
                />
              </div>
                  ...
                  <CgPlayListAdd
                    ...
                    onClick={(e) => {
                      ...
                      navigate("/dashboard/playlist", {
                        state: { songId: trendingmusic._id },
                      });
                    }}
                  />
                </p>
